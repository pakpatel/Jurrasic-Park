            ...
            XDEF Pen2
            XREF travel,init_LCD,read_pot,display_string,pot_value,KeyPad,feed2,roar2,hunger2,keyval,disp,traveling
...
Pen2:      ldab hunger2           ;gets hunger val and an array with the leds that match index of hunger val
           ldx  #seq1
